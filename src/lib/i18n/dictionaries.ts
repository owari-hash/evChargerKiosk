...
export const en = {
  ...
  footer: {
    rights: '© Жиркто ХХК ©  {year} Бүх эрх хуулиар баталгаажсан. Version 1.0.9',
    terms: 'Terms',
    privacy: 'Privacy',
  },
  ...
  auth: {
    ...
    phoneHint: 'Type your local number — the country code is added for you.',
    pinLabel: 'PIN code',
    pinHint: 'Enter your 4-digit PIN',
    newPinLabel: 'Create a 4-digit PIN',
    confirmPinLabel: 'Repeat the PIN',
    pinMismatch: 'The PINs do not match. Type it again.',
    codeLabel: '6-digit code',
    codeSentTo: 'We texted a code to {destination}. It expires in 10 minutes.',
    ...
    register: {
      ...
      subtitle: 'Your phone number and a 4-digit PIN — that is all.',
      ...
      pinBody: 'You will sign in with your phone number and this PIN.',
    ...
    forgot: {
      ...
      subtitle: 'We text a code to your number, then you choose a new PIN.',
      footerPrompt: 'Still stuck?',
      failed: 'We could not reset your PIN.',
      phoneTitle: 'Enter your phone number',
      codeTitle: 'Enter the code we texted you',
      pinTitle: 'Choose a new PIN',
      pinBody: 'Every other device signed in to this account will be signed out.',
      submit: 'Save new PIN',
...
export const mn: Dictionary = {
  ...
  auth: {
    ...
    phonePlaceholder: '9911 2233',
    phoneHint: 'Дотоодын дугаараа бичнэ үү — улсын код автоматаар нэмэгдэнэ.',
    pinLabel: 'PIN код',
    pinHint: '4 оронтой PIN кодоо оруулна уу',
    newPinLabel: '4 оронтой PIN код үүсгэх',
    confirmPinLabel: 'PIN кодоо давтах',
    pinMismatch: 'PIN код таарахгүй байна. Дахин оруулна уу.',
    codeLabel: '6 оронтой код',
    codeSentTo: '{destination} дугаар руу код илгээлээ. 10 минутын дараа хүчингүй болно.',
    resendCode: 'Шинэ код авах',
    resendIn: '{seconds} секундын дараа шинэ код авах',
    ...
    register: {
      ...
      subtitle: 'Утасны дугаар, 4 оронтой PIN код — ердөө л энэ.',
      ...
      codeTitle: 'SMS-ээр ирсэн кодыг оруулна уу',
      pinTitle: 'PIN код үүсгэх',
      pinBody: 'Та утасны дугаар болон энэ PIN кодоороо нэвтэрнэ.',
      submit: 'Бүртгүүлэх',
      agreePrefix: 'Би',
      agreeMiddle: 'болон',
    ...
    forgot: {
      ...
      title: 'PIN кодоо сэргээх',
      subtitle: 'Таны дугаар руу код илгээнэ, дараа нь шинэ PIN код сонгоно.',
      footerPrompt: 'Асуудал үргэлжилж байна уу?',
      failed: 'PIN кодыг шинэчилж чадсангүй.',
      phoneTitle: 'Утасны дугаараа оруулна уу',
      codeTitle: 'SMS-ээр ирсэн кодыг оруулна уу',
      pinTitle: 'Шинэ PIN код сонгох',
      pinBody: 'Энэ бүртгэлээр нэвтэрсэн бусад бүх төхөөрөмжөөс гарна.',
      submit: 'Шинэ PIN хадгалах',
