...
export const en = {
  ...
  footer: {
    rights: '© {year} Жиркто ХХК. All rights reserved. Version 1.0.9',
    terms: 'Terms',
    privacy: 'Privacy',
  },
  ...
  account: {
    ...
    pin: {
      title: 'PIN code',
      signOutHint: 'Changing your PIN signs out every other device that is still using this account.',
      noPinYet: 'This account has no PIN yet. Set one to sign in with your phone number.',
      currentLabel: 'Current PIN',
      currentBody: 'Enter your current PIN to confirm it’s you.',
      newLabel: 'New PIN',
      newBody: 'The new 4-digit PIN you’ll sign in with.',
      confirmLabel: 'Confirm new PIN',
      confirmBody: 'Enter the new PIN once more.',
      again: 'Change it again',
      submitButton: 'Change PIN',
      setButton: 'Set PIN',
      changed: 'Your PIN has been changed. Other devices are now signed out.',
      failed: 'Could not change your PIN. Please try again.',
    },
    ...
    verification: {
      ...
      emailMissing:
        'No email on this account. Add one on the Overview tab to get charging receipts by email.',
      ...
      phonePending:
        'Verify a mobile number so we can text you about a charge that needs attention, and so you can reset your PIN by SMS.',
  ...
  home: {
    map: {
      ...
      groupCar: 'My car',
      carHint: 'Pick your car’s charging ports. Ports can differ between market versions of the same model, so check yours.',
      carMatch: 'Fits your car',
      carUnverified: 'Ports not listed — check at the station',
      favorites: 'Favourites',
      addFavorite: 'Save to favourites',
      removeFavorite: 'Remove from favourites',
      favoriteSaved: 'Saved to favourites · kept in this browser',
      favoriteRemoved: 'Removed from favourites',
      nearestSelected: 'Selected the nearest station that matches your filters',
      distanceUpdated: 'Distances updated · straight-line estimate',
      inArea: '{count} stations in this area',
      ofTotal: '{total} match your filters',
      freshLive: 'Updated in real time',
      freshHour: 'Updated in the last hour',
      freshStale: 'May be out of date',
      freshUnknown: 'Update time not reported',
    },
  ...
  auth: {
    ...
    codeSentTo: 'Enter the 6-digit code sent to {destination}. It’s valid for 10 minutes.',
    ...
    continue: 'Continue',
    verifyCode: 'Verify',
    visualTitle: 'Every charge in one place',
    visualBody: 'Find a station, pay with QPay and keep your charging history in your account.',
    ...
    register: {
      ...
      pinBody: 'Choose a 4-digit PIN to sign in with.',
      ...
      agreeSuffix: '',
      mustAccept: 'Agree to the terms to continue',
    },

    forgot: {
      metaTitle: 'Forgot PIN',
      metaDescription: 'Get a code by SMS and choose a new 4-digit PIN.',
      title: 'Reset your PIN',
      subtitle: 'We’ll send a verification code to your registered number.',
      failed: 'We could not reset your PIN.',
      phoneTitle: 'Mobile number',
      codeTitle: 'Verification code',
      pinTitle: 'New PIN',
      pinBody: 'You’ll be signed out on your other devices.',
      submit: 'Save PIN',
  ...
  help: {
    metaTitle: 'Help',
    metaDescription:
      'Answers to the common questions about finding a charger, plug types, charge tags, the wallet, PINs and offline stations.',
    title: 'Help',
    intro:
    ...
    q5: 'How do I reset my PIN?',
    a5: 'Tap “Forgot your PIN?” on the sign-in page and enter the phone number on your account. We text a six-digit code that is valid for 10 minutes; enter it, then choose a new 4-digit PIN. Resetting your PIN signs you out everywhere else. After five wrong PINs in a row the account locks for 15 minutes, and after ten only a reset unlocks it.',
  ...
  privacy: {
    ...
    itemNameBody: 'Only if you add one on your account page. Used to address you in the interface.',
    itemEmail: 'Email address (optional)',
    itemEmailBody:
...
export const mn: Dictionary = {
  ...
  footer: {
    rights: '© {year} Жиркто ХХК. Бүх эрх хуулиар баталгаажсан. Version 1.0.9',
  ...
  account: {
    ...
    noEmailYet: 'И-мэйл нэмээгүй байна',
    addEmail: 'И-мэйл нэмэх',
    ...
    pin: {
      title: 'PIN код',
      signOutHint: 'PIN кодоо солиход энэ бүртгэлийг ашиглаж буй бусад бүх төхөөрөмжөөс автоматаар гарна.',
      noPinYet: 'Энэ бүртгэлд PIN код алга. Утасны дугаараараа нэвтрэхийн тулд PIN код тохируулна уу.',
      currentLabel: 'Одоогийн PIN код',
      currentBody: 'Баталгаажуулахын тулд одоогийн PIN кодоо оруулна уу.',
      newLabel: 'Шинэ PIN код',
      newBody: 'Нэвтрэхэд ашиглах шинэ 4 оронтой код.',
      confirmLabel: 'Шинэ PIN кодоо давтах',
      confirmBody: 'Шинэ PIN кодоо дахин оруулна уу.',
      again: 'Дахин солих',
      submitButton: 'PIN код солих',
      setButton: 'PIN код тохируулах',
      changed: 'PIN код тань солигдлоо. Бусад төхөөрөмжөөс гарсан байна.',
      failed: 'PIN кодыг тань солиж чадсангүй. Дахин оролдоно уу.',
    },
    ...
    verification: {
      ...
      emailMissing:
        'Энэ бүртгэлд и-мэйл алга. Цэнэглэлтийн баримтыг и-мэйлээр авах бол «Хувийн мэдээлэл» хэсэгт нэмнэ үү.',
      ...
      phonePending:
        'Анхаарал шаардсан цэнэглэлтийн талаар мессеж хүлээн авах, мөн SMS-ээр PIN кодоо сэргээхийн тулд гар утасны дугаараа баталгаажуулна уу.',
  ...
  home: {
    map: {
      ...
      zoomIn: 'Томруулах',
      zoomOut: 'Жижигрүүлэх',
      searchPlaceholder: 'Станц хайх',
      clearSearch: 'Хайлт цэвэрлэх',
      groupCar: 'Машинаа сонгох',
      carHint: 'Машиныхаа цэнэглэх портыг сонгоно уу. Нэг загварын зах зээлийн хувилбарууд өөр порттой байж болох тул өөрийнхөө машиныг шалгаарай.',
      carMatch: 'Таны машинд шууд таарна',
      carUnverified: 'Порт тодорхойгүй — станц дээр шалгана уу',
      favorites: 'Дуртай',
      addFavorite: 'Дуртай цэгт хадгалах',
      removeFavorite: 'Дуртай цэгээс хасах',
      favoriteSaved: 'Дуртай цэгт хадгаллаа · Энэ браузерт хадгалагдана',
      favoriteRemoved: 'Дуртай цэгээс хаслаа',
      nearestSelected: 'Шүүлтүүрт тохирох хамгийн ойр станцыг сонголоо',
      distanceUpdated: 'Зай шинэчлэгдлээ · Шулуун шугамын ойролцоо зай',
      inArea: 'Энэ хэсэгт {count} станц',
      ofTotal: 'Шүүлтүүрт нийт {total} станц тохирсон',
      freshLive: 'Бодит хугацаанд шинэчлэгдсэн',
      freshHour: 'Сүүлийн 1 цагт шинэчлэгдсэн',
      freshStale: 'Мэдээлэл хуучирсан байж болзошгүй',
      freshUnknown: 'Шинэчилсэн огноо баталгаажаагүй',
    },
  ...
  auth: {
    ...
    phonePlaceholder: '9911 2233',
    phoneHint: 'Баталгаажуулах код энэ дугаар руу SMS-ээр илгээгдэнэ.',
    pinLabel: 'PIN код',
    pinHint: '4 оронтой PIN кодоо оруулна уу',
    newPinLabel: 'PIN код',
    confirmPinLabel: 'PIN код давтах',
    pinMismatch: 'PIN код таарахгүй байна. Дахин оруулна уу.',
    codeLabel: '6 оронтой код',
    codeInvalid: '6 оронтой кодоо оруулна уу',
    codeSentTo: '{destination} дугаар руу 6 оронтой код илгээлээ. Код 10 минутын турш хүчинтэй.',
    resendCode: 'Код дахин илгээх',
    resendIn: 'Код дахин илгээх ({seconds} сек)',
    changeNumber: 'Дугаар солих',
    stepOf: 'Алхам {step}/3',
    continue: 'Үргэлжлүүлэх',
    verifyCode: 'Баталгаажуулах',
    visualTitle: 'Цэнэглэлт бүрээ нэг дороос',
    visualBody: 'Станцаа олж, QPay-ээр төлөөд, цэнэглэлтийн түүхээ бүртгэлээсээ хянаарай.',
    visualCharging: 'Цэнэглэж байна',
    ...
    login: {
      ...
      title: 'Нэвтрэх',
      subtitle: 'Утасны дугаар болон PIN кодоороо нэвтэрнэ үү.',
      helpCenter: 'Тусламжийн төв',
      failed: 'Нэвтэрч чадсангүй.',
      forgotPin: 'PIN кодоо мартсан уу?',
      submit: 'Нэвтрэх',
    ...
    register: {
      ...
      subtitle: 'Гар утасны дугаараараа хэдхэн алхмаар бүртгүүлнэ үү.',
      failed: 'Бүртгэл үүсгэж чадсангүй.',
      phoneTitle: 'Гар утасны дугаар',
      codeTitle: 'Баталгаажуулах код',
      pinTitle: 'PIN код үүсгэх',
      pinBody: 'Нэвтрэхэд ашиглах 4 оронтой нууц кодоо үүсгэнэ үү.',
      submit: 'Бүртгүүлэх',
      agreePrefix: 'Би ',
      termsLink: 'Нөхцөл',
      agreeMiddle: ', ',
      privacyLink: 'Нууцлалын бодлогыг',
      agreeSuffix: ' зөвшөөрч байна',
      mustAccept: 'Үргэлжлүүлэхийн тулд нөхцөлийг зөвшөөрнө үү',
    },

    forgot: {
      metaTitle: 'PIN код мартсан',
      metaDescription: 'SMS-ээр код аваад шинэ 4 оронтой PIN код тохируулна уу.',
      title: 'PIN код сэргээх',
      subtitle: 'Бүртгэлтэй дугаар руу тань баталгаажуулах код илгээнэ.',
      failed: 'PIN кодыг шинэчилж чадсангүй.',
      phoneTitle: 'Гар утасны дугаар',
      codeTitle: 'Баталгаажуулах код',
      pinTitle: 'Шинэ PIN код',
      pinBody: 'Бусад төхөөрөмж дээрх нэвтрэлт автоматаар цуцлагдана.',
      submit: 'Хадгалах',
  ...
  help: {
    metaTitle: 'Тусламж',
    metaDescription:
      'Цэнэглэх цэг олох, холбогчийн төрөл, цэнэглэх карт, хэтэвч, PIN код болон холбогдоогүй станцын талаарх түгээмэл асуултын хариулт.',
    title: 'Тусламж',
    intro:
    ...
    q5: 'PIN кодоо хэрхэн сэргээх вэ?',
    a5: 'Нэвтрэх хуудасны «PIN кодоо мартсан уу?» дээр дарж бүртгэлийнхээ утасны дугаарыг оруулна уу. Бид 10 минут хүчинтэй 6 оронтой кодыг SMS-ээр илгээнэ; түүнийг оруулаад шинэ 4 оронтой PIN код сонгоно. PIN кодоо сэргээхэд бусад бүх төхөөрөмжөөс гарна. PIN кодыг дараалан 5 удаа буруу оруулбал бүртгэл 15 минут түгжигдэж, 10 удаа буруу оруулбал зөвхөн сэргээснээр нээгдэнэ.',
  ...
  privacy: {
    ...
    itemName: 'Нэр (заавал биш)',
    itemNameBody: 'Зөвхөн та бүртгэлийн хуудсандаа нэмсэн тохиолдолд. Интерфэйс дээр танд хандахад ашиглана.',
    itemEmail: 'И-мэйл хаяг (заавал биш)',
    itemEmailBody:
