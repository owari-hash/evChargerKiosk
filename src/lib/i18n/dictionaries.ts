...
export const en = {
  ...
  home: {
    title: 'Charge where you are already going.',
    subtitle:
      'Live plug availability, clear pricing and directions for every charge point on the network.',
    networkTitle: 'Chargers on the network',
    networkSubtitle:
      'A snapshot of the network. Open the finder to filter by connector, power and distance.',
    seeAll: 'See all chargers',
    noStations: 'No charge points are being reported right now. Please try again shortly.',
    howItWorks: 'How it works',
    step1Title: 'Find a charger',
    step1Body:
      'Search by place or share your location to see what is free right now, with live plug status from every charge point.',
    step2Title: 'Plug in',
    step2Body:
      'Hold your charge tag against the reader, or start the session from your phone where the station supports it.',
    step3Title: 'Track and pay',
    step3Body:
      'Watch energy, power and cost while you charge, and pay straight from your wallet balance.',
    ctaTitle: 'Create a free account',
    ctaBody:
      'Link your charge tag, top up your wallet and keep every receipt in one place.',
  },
...
export const mn: Dictionary = {
  ...
  home: {
    title: 'Явж буй замдаа цэнэглээрэй.',
    subtitle:
      'Сүлжээний бүх цэнэглэх цэгийн холбогчийн сул байдал, тодорхой үнэ, чиглэлийг шууд харна уу.',
    networkTitle: 'Сүлжээний цэнэглэх цэгүүд',
    networkSubtitle:
      'Сүлжээний товч байдал. Холбогч, хүчин чадал, зайгаар шүүхийн тулд хайлтыг нээнэ үү.',
    seeAll: 'Бүх цэнэглэх цэг',
    noStations: 'Одоогоор ямар ч цэнэглэх цэг мэдээлэл илгээгээгүй байна. Дараа дахин оролдоно уу.',
    howItWorks: 'Хэрхэн ажилладаг вэ',
    step1Title: 'Цэнэглэх цэг олох',
    step1Body:
      'Байршлаараа хайх эсвэл байршлаа хуваалцаад одоо сул байгаа цэгүүдийг холбогчийн шууд төлөвтэй нь харна уу.',
    step2Title: 'Залгах',
    step2Body:
      'Картаа уншуулах эсвэл дэмждэг станц дээр утаснаасаа цэнэглэлтээ эхлүүлээрэй.',
    step3Title: 'Хянаж, төлөх',
    step3Body:
      'Цэнэглэх явцад эрчим хүч, хүчин чадал, төлбөрөө хараад хэтэвчнийхээ үлдэгдлээс шууд төлнө үү.',
    ctaTitle: 'Үнэгүй бүртгэл үүсгэх',
    ctaBody:
      'Картаа холбож, хэтэвчээ цэнэглээд бүх баримтаа нэг дор хадгалаарай.',
  },
  ...
  stations: {
    ...
    quickPlaceholder: 'Байршил, хаяг эсвэл сүлжээгээр хайх',
    statusLabel: 'Төлөв',
    anyStatus: 'Бүх төлөв',
